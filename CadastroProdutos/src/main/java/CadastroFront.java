...
public class CadastroFront extends javax.swing.JFrame {
    ...
    //Array List (Dinâmico [Inserção e Remoção direta])
    ...
    //------------------------------//Aplicação - Inserção e Alteração//------------------------------//
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (quantidadeExcedente == 0){
            ...
            for(int i = 0; i < indexArray; i++){
                prodList.addElement(codProduto[i]+" "+nomeProduto[i]+" "+precoProduto[i]+" "+quantidadeProduto[i]);
                
            }        
        
            
            jList1.setModel(prodList);
            ...
            opFalha();
            beepWindowsVerification();
            messageBoxVerification("A quantidade minima de dados não foi inserida");          
        }
          ...
          (precoProduto[0] == null || "".equals(precoProduto[0].trim())))){        
            ...
            if(revEscolha.isEmpty()){
                ...
                for(int i = 0; i < revEscolha.size(); i++){
                        ...
                        prodList.addElement("\t "+codProduto[revEscolha.get(i)]+""+nomeProduto[revEscolha.get(i)]+""+precoProduto[revEscolha.get(i)]+""+quantidadeProduto[revEscolha.get(i)]);
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroFront().setVisible(true);
            }
        });
    }
